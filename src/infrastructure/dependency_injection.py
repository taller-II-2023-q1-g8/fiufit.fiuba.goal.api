...
from src.infrastructure.goal.goal_repository_mongodb import\
    GoalRepositoryMongoDB
...
from src.infrastructure.metric.metric_repository_mongodb import\
    MetricRepositoryMongoDB
from src.usecase.goals_service import GoalService
from src.usecase.metrics_service import MetricService
from src.infrastructure.mongodb_connection import metrics_collection,\
    goals_collection
...
# Goals Query Module
goals_query_module = GoalQuery(
    goals_collection, goal_factory, metrics_query_module)

# Goals Application Service
goals_service = GoalService(
    goals_repository, goals_query_module, goal_factory)
