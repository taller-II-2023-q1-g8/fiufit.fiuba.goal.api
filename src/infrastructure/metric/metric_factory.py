...
from src.domain.metric.metric import CaloriesBurned, DistanceTravelled,\
    ExerciseSetCompleted, Metric, TrainingPlanCompleted, WeightMeasured
...
class MetricFactory:
    ...
    def from_dict(self, metric_dict: dict) -> Metric:
        ...
        match metric_dict['type']:
            ...
            case _:
                raise ValueError(
                    f"Invalid metric type {metric_dict['type']}"
                    )
